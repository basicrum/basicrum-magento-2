...
- The Composer package is `basicrum/basicrum-magento-2`, with the public title
  "Basicrum Analytics" and distribution filename `basicrum-magento-2.zip`.
...
- Validate package metadata through Composer's validating VCS importer in CI,
  catching import-stage errors that standalone validation misses.
